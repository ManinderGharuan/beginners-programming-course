...
Every looping construct always able to terminate and it does give a reasonable answer
...
- Try reasonable values until you find the solution
...
** For loop
- for loop is updating variable automatically
...
** Range
- Range is build-in python function
- It gives all the integer from lower to upper
...
- It is immutable
- Representation of tuple is square bracket, followed by a sequence of element, separated by commas and followed by a close square bracket
  e.g t = (1, 2, 3, 4)
